...
export class OrdenController {
  ...
  async reprogramarOrden(
    ...
    return await this.reprogramarCommand
      .setParams(id, new Date(body.nuevaFechaInicio), body.motivo, body.usuarioId)
      .execute();
  }
  ...
  async confirmarEjecucion(
    ...
    return await this.confirmarCommand
      .setParams(id, body.usuarioId, body.comentarios)
      .execute();
  }
}
