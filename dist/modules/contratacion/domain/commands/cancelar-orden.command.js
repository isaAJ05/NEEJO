...
let CancelarOrdenCommand = class CancelarOrdenCommand {
    ...
    async validate(params) {
        ...
        const estadosPermitidos = [client_1.EstadoOrden.CREADA, client_1.EstadoOrden.ASIGNADA, client_1.EstadoOrden.EN_PROGRESO];
    ...
    async execute(params) {
        ...
        const ordenActualizada = await this.prisma.ordenServicio.update({
            where: { id: params.ordenId },
            data: {
                estado: client_1.EstadoOrden.CANCELADA,
        ...
        await this.prisma.historialEstado.create({
            data: {
                ...
                estadoNuevo: client_1.EstadoOrden.CANCELADA,
                motivo,
