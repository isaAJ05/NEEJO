...
let ReprogramarOrdenCommand = class ReprogramarOrdenCommand {
    ...
    async validate(params) {
        ...
        if (orden.estado === client_1.EstadoOrden.COMPLETADA || orden.estado === client_1.EstadoOrden.CANCELADA) {
    ...
    async execute(params) {
        ...
        const ordenActualizada = await this.prisma.ordenServicio.update({
            ...
            data: {
                ...
                estado: client_1.EstadoOrden.REPROGRAMADA,
            },
        });
        await this.prisma.historialEstado.create({
            data: {
                ...
                estadoNuevo: client_1.EstadoOrden.REPROGRAMADA,
